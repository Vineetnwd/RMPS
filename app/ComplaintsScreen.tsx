...
const styles = StyleSheet.create({
  ...
  filterButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, paddingHorizontal: 6, borderRadius: 12, backgroundColor: COLORS.cardBg, gap: 4, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 2, elevation: 1 },
  ...
  complaintCard: { backgroundColor: COLORS.cardBg, borderRadius: 18, marginBottom: 14, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)' },
  statusBar: { height: 4 },
  ...
  studentInfo: { flex: 1 },
  studentName: { fontSize: 16, fontWeight: '700', color: COLORS.ink, marginBottom: 6 },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
  classText: { fontSize: 12, color: COLORS.gray, fontWeight: '500' },
  complaintTo: { fontSize: 13, fontWeight: '700', color: COLORS.secondary },
  statusBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12, gap: 4 },
  statusText: { fontSize: 11, fontWeight: '700' },
  complaintPreview: { backgroundColor: COLORS.cream, padding: 14, borderRadius: 14 },
  complaintText: { fontSize: 14, color: COLORS.gray, lineHeight: 22 },
  expandedContent: { marginTop: 14, paddingTop: 14, borderTopWidth: 1, borderTopColor: COLORS.lightGray },
  ...
  contactText: { fontSize: 14, fontWeight: '700', color: COLORS.secondary },
  responseSection: { backgroundColor: 'rgba(16, 185, 129, 0.1)', padding: 14, borderRadius: 14 },
  responseLabelCard: { fontSize: 13, fontWeight: '700', color: COLORS.success, marginBottom: 8 },
  responseTextCard: { fontSize: 14, color: COLORS.gray, lineHeight: 22 },
  ...
  modalContent: { backgroundColor: COLORS.cardBg, borderTopLeftRadius: 28, borderTopRightRadius: 28, maxHeight: '85%' },
  ...
  studentCard: { backgroundColor: COLORS.cream, borderRadius: 16, padding: 16, marginBottom: 16 },
  studentCardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 14, gap: 10 },
  ...
  studentCardTitle: { fontSize: 16, fontWeight: '700', color: COLORS.ink },
  ...
  modalValue: { fontSize: 15, fontWeight: '700', color: COLORS.ink },
  modalValueTo: { fontSize: 15, fontWeight: '700', color: COLORS.secondary, marginLeft: 24 },
  mobileValue: { fontSize: 15, fontWeight: '700', color: COLORS.secondary },
  modalValueComplaint: { fontSize: 15, color: COLORS.gray, lineHeight: 24, marginLeft: 24 },
  responseContainer: { marginTop: 8, marginBottom: 20 },
  responseLabel: { fontSize: 14, fontWeight: '700', color: COLORS.ink, marginBottom: 10 },
  responseInput: { backgroundColor: COLORS.cream, borderRadius: 14, padding: 14, fontSize: 14, color: COLORS.ink, minHeight: 100, textAlignVertical: 'top', borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)' },
