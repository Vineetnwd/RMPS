...
const styles = StyleSheet.create({
    ...
    scrollContainer: { flex: 1, backgroundColor: '#FDF5F7' },
    scrollContent: { padding: 20 },
    branchListHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, gap: 10 },
    ...
    branchListTitle: { fontSize: 12, fontWeight: '700', color: COLORS.ink },
    branchCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FDF5F7', padding: 10, borderRadius: 12, marginBottom: 12, borderWidth: 2, borderColor: 'transparent', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.03, shadowRadius: 8, elevation: 2 },
    branchCardSelected: { borderColor: COLORS.primary, backgroundColor: COLORS.primary },
    branchIconContainer: { width: 40, height: 40, borderRadius: 10, backgroundColor: 'rgba(122, 12, 46, 0.1)', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
    branchIconContainerSelected: { backgroundColor: 'rgba(255, 255, 255, 0.2)' },
    branchInfo: { flex: 1 },
    branchName: { fontSize: 12, fontWeight: '700', color: COLORS.ink, marginBottom: 4 },
    branchNameSelected: { color: COLORS.white },
    branchId: { fontSize: 12, color: COLORS.gray, fontWeight: '500' },
    ...
    switchingText: { marginTop: 10, fontSize: 12, fontWeight: '600', color: COLORS.white },
