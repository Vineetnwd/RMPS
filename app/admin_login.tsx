...
export default function AdminLogin() {
  ...
  const storeUserData = async (userData: any) => {
    try {
      ...
      if (userData.allowed_branch) {
        await AsyncStorage.setItem('allowed_branch', userData.allowed_branch.toString());
      }
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await axios.post(
        'https://rmpublicschool.org/binex/api.php?task=login',
        {
          user_name: username,
          user_pass: password
        }
            ...
            <View style={styles.innerContainer}>
              ...
              >
                <View style={styles.portalPill}>
                  ...
                  <Text style={styles.portalPillText}>ADMIN PORTAL</Text>
                </View>
              </Animated.View>
              ...
              <Animated.View style={[styles.footer, { opacity: fadeAnim }]}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Ionicons name="people-circle-outline" size={18} color={COLORS.secondary} />
