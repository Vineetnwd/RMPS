...
const styles = StyleSheet.create({
  ...
  keyboardAvoidView: { flex: 1, backgroundColor: COLORS.background },
  ...
  formLabel: { fontSize: 14, fontWeight: '700', color: COLORS.ink },
  formLabelHint: { fontSize: 12, color: COLORS.gray, marginBottom: 10, marginLeft: 34 },
  dateSelector: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.cardBg, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  dateSelectorIcon: { width: 50, height: 54, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(212, 175, 55, 0.1)' },
  dateText: { flex: 1, fontSize: 15, color: COLORS.ink, fontWeight: '700', paddingHorizontal: 14 },
  datePickerButton: { backgroundColor: COLORS.primary, height: 54, width: 50, alignItems: 'center', justifyContent: 'center' },
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.cardBg, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  ...
  input: { flex: 1, height: 54, fontSize: 15, color: COLORS.ink, paddingHorizontal: 14 },
  ...
  textArea: { fontSize: 15, color: COLORS.ink, minHeight: 120, lineHeight: 24 },
  ...
  uploaderContainer: { borderWidth: 2, borderColor: COLORS.lightGray, borderRadius: 16, padding: 16, backgroundColor: COLORS.cream, borderStyle: 'dashed' },
  ...
  fileIconContainer: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  ...
  successPopup: { backgroundColor: COLORS.cardBg, borderRadius: 24, padding: 40, alignItems: 'center', width: width * 0.85, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.25, shadowRadius: 16, elevation: 10 },
  ...
  successPopupTitle: { fontSize: 24, fontWeight: '800', color: COLORS.ink, marginBottom: 8 },
  successPopupText: { fontSize: 16, color: COLORS.gray, textAlign: 'center', fontWeight: '500' },
