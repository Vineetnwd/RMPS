...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: COLORS.primary, paddingTop: 10, paddingBottom: 24, borderBottomLeftRadius: 28, borderBottomRightRadius: 28, overflow: 'hidden' },
  ...
  searchBoxContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.cardBg, borderRadius: 16, padding: 8, paddingLeft: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 4 },
  searchIconContainer: { marginRight: 10 },
  searchInput: { flex: 1, fontSize: 16, color: COLORS.ink, height: 40 },
  ...
  sectionTitle: { fontSize: 13, fontWeight: '700', color: COLORS.gray, marginLeft: 20, marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 },
  recentList: { paddingHorizontal: 20 },
  recentPill: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.cardBg, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, marginRight: 10, borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 2, elevation: 1 },
  recentIcon: { marginRight: 6 },
  recentText: { fontSize: 13, fontWeight: '600', color: COLORS.ink },

  listContainer: { padding: 20, paddingBottom: 40 },
  resultsCount: { fontSize: 13, color: COLORS.gray, fontWeight: '600', marginBottom: 12, textAlign: 'center' },

  studentCard: { backgroundColor: COLORS.cardBg, borderRadius: 18, marginBottom: 16, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)' },
  statusBar: { height: 4 },
  cardContent: { padding: 16 },
  cardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  avatarContainer: { width: 50, height: 50, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginRight: 14 },
  avatarText: { fontSize: 20, fontWeight: '800' },
  studentInfo: { flex: 1 },
  studentName: { fontSize: 16, fontWeight: '700', color: COLORS.ink, marginBottom: 4 },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  classText: { fontSize: 12, color: COLORS.gray, fontWeight: '500' },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  statusText: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },

  detailsContainer: { backgroundColor: COLORS.background, borderRadius: 12, padding: 12, gap: 8, marginBottom: 16 },
  detailRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  detailLabel: { fontSize: 13, color: COLORS.gray, fontWeight: '500', width: 60 },
  detailValue: { fontSize: 13, color: COLORS.ink, fontWeight: '600', flex: 1 },
  ...
  actionButtonText: { fontSize: 13, fontWeight: '700', color: COLORS.white },
  ...
  loadingText: { fontSize: 16, fontWeight: '600', color: COLORS.gray },
  ...
  retryButton: { marginTop: 20, paddingVertical: 10, paddingHorizontal: 20, backgroundColor: COLORS.primary, borderRadius: 10 },
