...
const styles = StyleSheet.create({
  ...
  filterButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, paddingHorizontal: 8, borderRadius: 12, backgroundColor: '#FDF5F7', gap: 6, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 2, elevation: 1 },
  ...
  leaveCard: { backgroundColor: '#FDF5F7', borderRadius: 10, marginBottom: 8, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.03, shadowRadius: 8, elevation: 1, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)' },
  statusBar: { height: 4 },
  ...
  studentInfo: { flex: 1 },
  studentId: { fontSize: 12, fontWeight: '700', color: COLORS.ink, marginBottom: 6 },
  ...
  expandedContent: { marginTop: 10, paddingTop: 16, borderTopWidth: 1, borderTopColor: COLORS.lightGray },
  reasonSection: { backgroundColor: '#FFF9F0', padding: 10, borderRadius: 10, marginBottom: 12 },
  reasonLabel: { fontSize: 12, fontWeight: '700', color: COLORS.primary, marginBottom: 8 },
  reasonText: { fontSize: 12, color: COLORS.gray, lineHeight: 22 },
  remarksSection: { backgroundColor: 'rgba(245, 158, 11, 0.1)', padding: 10, borderRadius: 14 },
  remarksLabelCard: { fontSize: 12, fontWeight: '700', color: COLORS.warning, marginBottom: 8 },
  remarksTextCard: { fontSize: 12, color: COLORS.gray, lineHeight: 22 },
  ...
  modalContent: { backgroundColor: '#FDF5F7', borderTopLeftRadius: 28, borderTopRightRadius: 28, maxHeight: '80%' },
  ...
  modalValue: { fontSize: 12, fontWeight: '700', color: COLORS.ink, marginLeft: 24 },
  modalValueReason: { fontSize: 12, color: COLORS.gray, lineHeight: 24, marginLeft: 24 },
  remarksContainer: { marginTop: 8, marginBottom: 20 },
  remarksLabel: { fontSize: 12, fontWeight: '700', color: COLORS.ink, marginBottom: 10 },
  remarksInput: { backgroundColor: '#FFF9F0', borderRadius: 10, padding: 10, fontSize: 12, color: COLORS.ink, minHeight: 90, textAlignVertical: 'top', borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.04)' },
